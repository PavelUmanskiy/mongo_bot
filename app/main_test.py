...
def test_aggregate_salary_data():
    test_input = [
        {
    ...
    test_output = [
        ...
        {
            "dataset": [
                8177, 8407, 4868, 7706, 8353, 7143, 6062, 11800, 4077, 8820, 4788, 11045, 13048, 
                2729, 4038, 9888, 7490, 11644, 11232, 12177, 2741, 5341, 8730, 4718, 0
            ],
            "labels": [
    ...
    all_ok = True
    zipped = zip(test_input, test_output)
    for input_, output in zipped:
        dt_from = input_['dt_from']
        dt_upto = input_['dt_upto']
        group_type = input_['group_type']
        processed_salary_data = utils.data_processing.aggregate_salary_data(
            main.salary_df,
            dt_from,
            dt_upto,
            group_type
        ...
        if processed_salary_data != output:
            print('='*100, 'DATA:', processed_salary_data, '='*100, sep='\n')
            print('='*100, 'EXPECTED OUTPUT:', output, '='*100, sep='\n')
            all_ok = False
